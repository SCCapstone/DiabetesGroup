/*--------------------------------------------------------------------------------------------------------------------------------
Screen Name: PatientSignIn

Puropse: This screen is used by Patients to sign in to their account.

Functions Used:
    _signIn: Verifies input to make sure username and password match and checks to ensure user type is a Patient.
