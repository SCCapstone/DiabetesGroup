/*--------------------------------------------------------------------------------------------------------------------------------
Screen Name: ClinicianSignIn

Puropse: This screen is used by Clinicians to sign in to their account.

Functions Used:
    _signIn: Verifies input to make sure username and password match and checks to ensure user type is a clinician.
